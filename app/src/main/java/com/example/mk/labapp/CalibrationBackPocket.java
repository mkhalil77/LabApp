...
public class CalibrationBackPocket extends AppCompatActivity {

    SensorData[] Temp;
    SensorData Center;
    SensorData CenterEar;
    SensorData CenterHand;
    SensorData CenterPocket;
    int a = 0;
    int b = 0;
    int c = 0, d = 0, e = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calibration_back_pocket);
        ...
        final TextView Processing = (TextView) findViewById(R.id.Processing);
        ...
        Record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Processing.setText("Center Being Calcuated !");
                ...
                SensorEventListener sensorListner = new SensorEventListener() {
                    ...
                    public void onSensorChanged(SensorEvent event) {
                        ...
                        if ((a == 100) && (b == 100) && (c == 100) && (d == 100) && (e == 100)) {
                            ...
                            Center = avg;
                            Processing.setText("Center : Acceleration vector : (" + df.format(avg.acceleration_vector[0]) + " ," + df.format(avg.acceleration_vector[1]) + ", " + df.format(avg.acceleration_vector[2]) + ") "
        ...
        NextPhase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenet = new Intent(CalibrationBackPocket.this, SensorReader.class);
                {


                    intenet.putExtra("CenterEar", CenterEar);
                    intenet.putExtra("CenterHand", CenterHand);
                    intenet.putExtra("CenterPocket", CenterPocket);
                    intenet.putExtra("CenterBackPocket", Center);
