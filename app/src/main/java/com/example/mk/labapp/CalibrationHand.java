...
public class CalibrationHand extends AppCompatActivity {
    SensorData[] Temp;
    SensorData Center;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextPhase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenet = new Intent(CalibrationHand.this, CalibrationPocket.class);
                {


                    intenet.putExtra("CenterEar", CenterEar);
                    intenet.putExtra("CenterHand", Center);
